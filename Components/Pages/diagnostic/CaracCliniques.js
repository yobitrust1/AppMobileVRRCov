            ...
            />
            {
                ...
                <View style={tailwind("px-8 py-2")}>
                    <TouchableOpacity onPress={() => setFievre(!fievre)}>
                        <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Fièvre</Text>
                    </TouchableOpacity>
                    {
                    ...
                    <TouchableOpacity onPress={() => setToux(!toux)} >
                        <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Toux</Text>
                    </TouchableOpacity>
                    {
                    ...
                    <TouchableOpacity onPress={() => setCeph(!cepah)}>
                        <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Cépahlées</Text>
                    </TouchableOpacity>
                    {
                    ...
                    <TouchableOpacity onPress={() => setAsth(!asth)}>
                        <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Asthénie/fatigue</Text>
                    </TouchableOpacity>
                    {
                    ...
                    <TouchableOpacity onPress={() => setMya(!mya)}>
                        <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Myalgies/courabatures</Text>
                    </TouchableOpacity>
                    {
                    ...
                    <TouchableOpacity onPress={() => setOdy(!ody)}>
                        <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Odynophagie</Text>
                    </TouchableOpacity>
                    {
                    ...
                    <TouchableOpacity onPress={() => setRhi(!rhi)}>
                        <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Rhinorrhée/Congestion nasale</Text>
                    </TouchableOpacity>
                    {
                    ...
                    <TouchableOpacity onPress={() => setAno(!ano)}>
                        <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Anosmie</Text>
                    </TouchableOpacity>
                    {
                    ...
                    <TouchableOpacity onPress={() => setAgu(!agu)}>
                        <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Agueusie</Text>
                    </TouchableOpacity>
                    {
                    ...
                    <TouchableOpacity onPress={() => setDia(!dia)}>
                        <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Diarrhée</Text>
                    </TouchableOpacity>
                    {
                    ...
                    <TouchableOpacity onPress={() => setNau(!nau)}>
                        <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Nausée/voumissement</Text>
                    </TouchableOpacity>
                    {
                    ...
                    <TouchableOpacity onPress={() => setEru(!eru)}>
                        <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>ERuption cutanée</Text>
                    </TouchableOpacity>
                    {
                    ...
                    <TouchableOpacity onPress={() => setEng(!eng)}>
                        <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Engelure</Text>
                    </TouchableOpacity>
                    {
                    ...
                    <TouchableOpacity onPress={() => setDou(!dou)}>
                        <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Douleur thoracique</Text>
                    </TouchableOpacity>
                    {
                    ...
                    <TouchableOpacity onPress={() => setGen(!gen)}>
                        <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Génie respiratoire</Text>
                    </TouchableOpacity>
                    {
                    ...
                    <TouchableOpacity onPress={() => setEss(!ess)}>
                        <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Essoufflement</Text>
                    </TouchableOpacity>
                    {
                    ...
                    <TouchableOpacity onPress={() => setAut(!aut)}>
                        <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Autres signes cliniques</Text>
                    </TouchableOpacity>
                    {

...
{!datePicker && (
  <View >
    <Button title={(datePr !== undefined && datePr.toDateString()) || "Show Date Picker"} color="#9035db" onPress={showDatePicker} />
          ...
          <FormInput placeholder="Na+" onChangeText={setNak} type="decimal-pad" min="0" max="100" />
          <FormInput placeholder="K+" onChangeText={setNak1} type="decimal-pad" min="0" max="100" />
          <FormInput placeholder="Na+ urinaire" onChangeText={setNakUr} type="decimal-pad" min="0" max="100" />
          <FormInput placeholder="K+ urinaire" onChangeText={setNakUr1} type="decimal-pad" min="0" max="100" />
          <FormButton title="Enregitrer" onPress={handleSubmit} />

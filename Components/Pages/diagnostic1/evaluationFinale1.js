...
{!datePicker && (
  <View >
    <Button title={(dateSor !== undefined && dateSor.toDateString()) || "Show Date Picker"} color="#9035db" onPress={showDatePicker} />
  </View>
      ...
      <View style={tailwind("items-center")}>
        ...
        {datePicker1 && (
          ...
          {!datePicker1 && (
            <View >
              <Button title={(dateDispSig !== undefined && dateDispSig.toDateString()) || "Show Date Picker"} color="#9035db" onPress={showDatePicker1} />
            </View>

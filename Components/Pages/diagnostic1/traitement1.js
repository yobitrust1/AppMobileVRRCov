...
/>
          {
              ...
              <View style={tailwind("px-8 py-2")}>
                  <TouchableOpacity onPress={() => setLop(!lop)}>
                      <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Lopinavir/ritonavir</Text>
                  </TouchableOpacity>
                  {
                     ...
                     <TouchableOpacity onPress={() => setChlo(!chlo)}>
                      <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Chloroquine phosphate</Text>
                  </TouchableOpacity>
                  {
                    ...
                    <TouchableOpacity onPress={() => setHydro(!hydro)}>
                      <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Hydroxy-Chloroquine</Text>
                  </TouchableOpacity>
                  {
                    ...
                    <TouchableOpacity onPress={() => setAzith(!azith)}>
                      <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Azithromycine</Text>
                  </TouchableOpacity>
                  {
                    ...
                    <TouchableOpacity onPress={() => setRem(!rem)}>
                      <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Remdesivir</Text>
                  </TouchableOpacity>
                  {
                    ...
                    <TouchableOpacity onPress={() => setOd(!od)}>
                      <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>O2</Text>
                  </TouchableOpacity>
                  {
                     ...
                     <TouchableOpacity onPress={() => setHfnc(!hfnc)}>
                      <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>HFNC</Text>
                  </TouchableOpacity>
                  {
                   ...
                   <TouchableOpacity onPress={() => setCpap(!cpap)}>
                      <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>CPAP</Text>
                  </TouchableOpacity>
                  {
                   ...
                   <TouchableOpacity onPress={() => setVni(!vni)}>
                      <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>VNI</Text>
                  </TouchableOpacity>
                  {
                  ...
                  <TouchableOpacity onPress={() => setVmi(!vmi)}>
                      <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>VMI</Text>
                  </TouchableOpacity>
                  {
                  ...
                  <TouchableOpacity onPress={() => setPara(!para)}>
                      <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Paracetamol</Text>
                  </TouchableOpacity>
                  {
                  ...
                  <TouchableOpacity onPress={() => setAnti(!anti)}>
                      <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Anti coagulant</Text>
                  </TouchableOpacity>
                  {
                  ...
                  <TouchableOpacity onPress={() => setHdo(!hdo)}>
                      <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>H2O</Text>
                  </TouchableOpacity>
                  {
                   ...
                   <TouchableOpacity onPress={() => setAdo(!ado)}>
                      <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>ADO</Text>
                  </TouchableOpacity>
                  {
                   ...
                   <TouchableOpacity onPress={() => setinsul(!insul)}>
                      <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Insulinotherapie</Text>
                  </TouchableOpacity>
                  {
                  ...
                  <TouchableOpacity onPress={() => setNebC(!nebC)}>
                      <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Nebulisation corticoides</Text>
                  </TouchableOpacity>
                  {
                   ...
                   <TouchableOpacity onPress={() => setNebB(!nebB)}>
                      <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Nebulisation bronchodilatateurs</Text>
                  </TouchableOpacity>
                  {
                   ...
                   <TouchableOpacity onPress={() => setAmoxi(!amoxi)}>
                      <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Amoxicilline/ Acide clavulanique</Text>
                  </TouchableOpacity>
                  {
                    ...
                    <TouchableOpacity onPress={() => setCefo(!cefo)}>
                      <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Cefotaxime</Text>
                  </TouchableOpacity>
                  {
                     ...
                     <TouchableOpacity onPress={() => setCeft(!ceft)}>
                      <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Ceftriaxone</Text>
                  </TouchableOpacity>
                  {
                    ...
                    <TouchableOpacity onPress={() => setAutreA(!autreA)}>
                      <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Autre</Text>
                  </TouchableOpacity>
                  {

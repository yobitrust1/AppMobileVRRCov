  ...
  <View >
    <Button title={(dateF !== undefined && dateF.toDateString()) || "Show Date Picker"} color="#9035db" onPress={showDatePicker1} />
      ...
      {datePicker2 && (
        ...
        {!datePicker2 && (
          <View >
            <Button title={(dateD !== undefined && dateD.toDateString()) || "Show Date Picker"} color="#9035db" onPress={showDatePicker2} />
          </View>
...
<View style={styles.row}>
      ...
      {datePicker3 && (
        ...
        {!datePicker3 && (
          <View >
            <Button title={(dateF !== undefined && dateF.toDateString()) || "Show Date Picker"} color="#9035db" onPress={showDatePicker3} />
          </View>

      ...
      <View style={tailwind(' items-center ')} >
        ...
        <View style={tailwind('py-8 px-8')}>
          <TouchableOpacity onPress={handleSejourChange}>
            <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Séjour ou transit dans une zone a risque</Text>
          </TouchableOpacity>
...
{!datePicker && (
  <View >
    <Button title={(dateD !== undefined && dateD.toDateString()) || "Show Date Picker"} color="#9035db" onPress={showDatePicker} />
  </View>
...
{!datePicker1 && (
  <View >
    <Button title={(dateF !== undefined && dateF.toDateString()) || "Show Date Picker"} color="#9035db" onPress={showDatePicker1} />
  </View>
          ...
          <TouchableOpacity onPress={handleAriveeChange}>
            <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Arivée sur le territoire tunisien </Text>
          </TouchableOpacity>
...
{!datePicker2 && (
  <View >
    <Button title={(dateEnt !== undefined && dateEnt.toDateString()) || "Show Date Picker"} color="#9035db" onPress={showDatePicker2} />
  </View>
          ...
          <TouchableOpacity onPress={handleParousChange}>
            <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Parcours en Tunisie</Text>
          </TouchableOpacity>
      ...
      {datePicker3 && (
        ...
        {!datePicker3 && (
          <View >
            <Button title={(dateV1 !== undefined && dateV1.toDateString()) || "Show Date Picker"} color="#9035db" onPress={showDatePicker3} />
          </View>
      ...
      {datePicker4 && (
        ...
        {!datePicker4 && (
          <View >
            <Button title={(dateV2 !== undefined && dateV2.toDateString()) || "Show Date Picker"} color="#9035db" onPress={showDatePicker4} />
          </View>
          ...
          <TouchableOpacity onPress={handleEtroitChange}>
            <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Contact étroit</Text>
          </TouchableOpacity>
          {
          ...
          {(contactC === "Oui" && etroit == true) && (<View style={tailwind("items-center")}>
            ...
            {datePicker5 && (
              ...
              {!datePicker5 && (
                <View >
                  <Button title={(dateDebutC !== undefined && dateDebutC.toDateString()) || "Show Date Picker"} color="#9035db" onPress={showDatePicker5} />
                </View>
      ...
      {datePicker6 && (
        ...
        {!datePicker6 && (
          <View >
            <Button title={(dateFinC !== undefined && dateFinC.toDateString()) || "Show Date Picker"} color="#9035db" onPress={showDatePicker6} />
          </View>
          ...
          <TouchableOpacity onPress={handleAutresChange}>
            <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Autres critères ayant conduit au classement en cas possible</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={handleQuarantineChange}>
            <Text style={tailwind('text-purple-500 font-bold text-base py-3 border border-solid border-purple-500 rounded-lg px-3 mt-4 mb-4')}>Mise en quarantine</Text>
          </TouchableOpacity>
...
{!datePicker7 && (
  <View >
    <Button title={(dateDQu !== undefined && dateDQu.toDateString()) || "Show Date Picker"} color="#9035db" onPress={showDatePicker7} />
  </View>
...
{!datePicker8 && (
  <View >
    <Button title={(dateFDQu !== undefined && dateFDQu.toDateString()) || "Show Date Picker"} color="#9035db" onPress={showDatePicker8} />
  </View>

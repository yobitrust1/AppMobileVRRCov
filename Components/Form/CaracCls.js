...
{!datePicker && (
  <View >
    <Button title={(props.dateD !== undefined && props.dateD.toDateString()) || "Show Date Picker"} color="#9035db" onPress={showDatePicker} />
  </View>
...
{!datePicker1 && (
  <View >
    <Button title={(props.dateF !== undefined && props.dateF.toDateString()) || "Show Date Picker"} color="#9035db" onPress={showDatePicker1} />
  </View>
